                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="{{ asset('img/portfolio/matri.jpg') }}" alt="..." />
                            </a>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="{{ asset('img/portfolio/union.jpg') }}" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div x-data="{}" class="portfolio-item">
                            <a class="portfolio-link" @click="$wire.emit('entity','fe-de-vida')"  data-bs-toggle="modal" href="#civilRegistryModal">
                                ...
                                <img class="img-fluid" src="{{ asset('img/portfolio/fedevida.jpg') }}" alt="..." />
                            </a>
                            <div class="portfolio-caption">
